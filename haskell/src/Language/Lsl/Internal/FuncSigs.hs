...
funcDescriptions = [    
    ...
    -- newish 20081101
    ("llDetectedTouchBinormal",(["index"],"For the specified touch event index, returns the surface binormal at the touch point.\n")),
    ("llDetectedTouchFace",(["index"],"For the specified touch event index, returns the face that was touched.\n")),
    ("llDetectedTouchNormal",(["index"],"For the specified touch event index, returns the surface normal at the touch point.\n")),
    ("llDetectedTouchPos",(["index"],"For the specified touch event index, returns the surface position at the touch point.\n")),
    ("llDetectedTouchST",(["index"],"For the specified touch event index, returns the surface face coordinates at the touch point.\n")),
    ("llDetectedTouchUV",(["index"],"For the specified touch event index, returns the surface face texture coordinates at the touch point.\n")),
    ("llGetAgentLanguage",(["avatar"],"Returns the language code for the specified agent/avatar key.\n")),
    ("llGetRegionAgentCount",([],"Returns the number of avatars in a region.\n")),
    ("llSHA1String",(["src"],"Returns the SHA1 security hash of src.\n"))
    ]
